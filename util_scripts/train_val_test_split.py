...
image_path = '/content/gdrive/MyDrive/datasets/images/all'
train_path = '/content/gdrive/MyDrive/datasets/images/train'
val_path = '/content/gdrive/MyDrive/datasets/images/validation'
test_path = '/content/gdrive/MyDrive/datasets/images/test'
